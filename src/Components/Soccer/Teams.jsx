                    ...
                    <Stack>
                        <CardBody>
                            ...
                            <Text py="2">
                                ...
                                Stadium name: <strong>{TeamsDetails.venue_name}</strong> with a capacity of <strong>{TeamsDetails.venue_capacity}</strong>.<br />
                                Located at: <strong>{TeamsDetails.venue_address}</strong> in <strong>{TeamsDetails.venue_city}</strong>.
                            </Text>
                        </CardBody>
                    </Stack>
                </Card>
